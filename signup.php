...
<head>
    ...
    <title>Catering Management - Create Account</title>
...
<body>
    ...
    <div class="container">
        <div class="auth-card">
            ...
            <div class="tabs">
                <a href="login.php" class="tab">Sign In</a>
                <div class="tab active">Create Account</div>
            </div>
            ...
            <div class="form-container">
                <!-- REGISTER FORM -->
                <form id="registerForm" class="form" action="auth.php" method="POST">
                    <input type="hidden" name="action" value="register">
                    
                    <div class="input-group">
                        <label for="reg-fullname">Full Name</label>
                        <div class="input-field">
                            <input type="text" id="reg-fullname" name="full_name" placeholder="John Doe" required>
                    ...
                    <div class="input-group">
                        ...
                        <div class="input-field">
                            ...
                            <div class="input-icon">
                                <svg class="icon-svg"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                            </div>
                        </div>
                    </div>
