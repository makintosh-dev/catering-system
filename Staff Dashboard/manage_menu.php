...
<div class="card" style="margin-bottom: 2rem;">
    ...
    <form action="Staff Dashboard/menu_actions.php" method="POST" style="display: flex; gap: 1rem; align-items: flex-end;">
...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1rem;">
        ...
        <form action="Staff Dashboard/menu_actions.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this entire package? All items inside will be lost.');">
    ...
    <table style="width: 100%; margin-bottom: 1.5rem;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="Staff Dashboard/menu_actions.php" method="POST" style="display: inline;" onsubmit="return confirm('Remove this item from the package?');">
