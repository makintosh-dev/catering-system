...
<head>
    ...
    <title>Client Dashboard - Mashaal Catering System</title>
...
<body>
    ...
    <main class="main-content">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>PKR <?= number_format($ro['total_amount'], 2) ?></td>
        ...
        <?php elseif ($page === 'menu'): ?>
            <?php require_once 'views/client_dashboard/menu.php'; ?>

        <!-- SHOPPING CART / PAYMENT -->
        <?php elseif ($page === 'cart'): ?>
            <?php require_once 'views/client_dashboard/payment.php'; ?>
